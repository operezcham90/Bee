...
// agregar las abejas al automata
   ...
   cout <<endl<< "===================Abejas en q0:" << m.countBeesInState(0)<<endl;
...
/**********************    E T A P A   D E  E X P L O R A C I O N *************************/
    ...
    proyec_der.clear();
    gen_no = 0;
    initialize(maxX, maxY, buf_F1, buf_F2);   //inicializacion de la poblacion y otras var. globales
    tiempo = time(NULL);
...
// pasar abejas a exploracion
   ...
   cout <<endl<< "===================Abejas en q1:" << m.countBeesInState(1)<<endl;
...
// pasar abejas a reclutamiento
   ...
   cout <<endl<< "===================Abejas en q3:" << m.countBeesInState(3)<<endl;
...
void opencv_abejas::initialize(int maxX, int maxY, IplImage *buf_F1, IplImage *buf_F2)
{
